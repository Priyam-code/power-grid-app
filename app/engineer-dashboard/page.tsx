...
import { ArrowLeft, LogOut, CheckCircle2, AlertCircle, Info } from 'lucide-react';
...
export default function EngineerDashboardPage() {
  ...
  useEffect(() => {
    ...
    if (savedEmail) setEngineerEmail(savedEmail);
    if (savedName) setEngineerName(savedName);
    if (savedRegion) setRegion(savedRegion);
  }, []);

  useEffect(() => {
    if (view !== 'engineer-portal' || !engineerEmail) return;
  ...
  const executeLogin = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    localStorage.setItem('engineerEmail', engineerEmail.trim().toLowerCase());
    localStorage.setItem('engineerName', engineerName.trim());
        ...
        {view === 'login-engineer' && (
          ...
          >
            ...
            <div className="w-full max-w-md">
              ...
              <form onSubmit={executeLogin} className="space-y-6 bg-[#1c1b1b] p-10 rounded-sm shadow-[0_20px_40px_rgba(0,0,0,0.5)]">
                <div>
          ...
          >
            ...
            <div className="flex-1 p-4 lg:p-12 overflow-y-auto">
              <header className="mb-12 border-b border-[#474747]/15 pb-8">
                ...
                <p className="text-neutral-400 text-sm mt-2">Status: <span className="text-white font-medium">On Duty</span></p>
              </header>
